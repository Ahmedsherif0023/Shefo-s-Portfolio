...
Replace the `public/images/Avatar1.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
<CodeBlock
  ...
  codeInstances={[
    ...
    description: "Portfolio website showcasing my work as a React.JS Dveleoper",
    headline: <>React.JS Dveleoper and builder</>,
    subline: (
      <>
        I'm Ahmed, a React.js Developer,  I craft fast, interactive web apps using React by building reusable components, managing state, and connecting to APIs with modern tools and best practices.
      </>
    ),
};`,
      language: "tsx",
